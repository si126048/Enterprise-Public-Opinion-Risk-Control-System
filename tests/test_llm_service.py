...
def test_mock_provider_result_fields():
    ...
    assert result.credibility_level in ("high", "medium", "low", "uncertain")
...
def test_deepseek_differs_from_mock():
    ...
    assert r_deep.credibility_level in ("high", "medium", "low", "uncertain")
...
def test_qwen_differs_from_mock():
    ...
    assert r_qwen.credibility_level in ("high", "medium", "low", "uncertain")
...
def test_providers_deterministic():
    ...
    assert r1.credibility_level == r2.credibility_level
    assert r1.risk_level == r2.risk_level
    assert r1.credibility_confidence == r2.credibility_confidence
